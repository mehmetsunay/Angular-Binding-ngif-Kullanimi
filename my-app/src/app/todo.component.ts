...
//boolean türünde olan ve check box denetımıne göre şekillenecek bir değişken tanımladım
...
//Yeni Ekleme Yapıyorum Boş Göndeim Yaparsam Alert Geliyor
...
return this.m.objcts.filter(item=>item.Durumu=='Beklemede');
